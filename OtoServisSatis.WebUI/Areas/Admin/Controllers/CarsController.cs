...
namespace OtoServisSatis.WebUI.Areas.Admin.Controllers
{
    ...
    public class CarsController : Controller
    {
        ...
        {
            ViewBag.MarkaId = new SelectList(await _serviceMarka.GetAllAsync(), "Id", "Adi");  //Araç ekle sayfasında marka adı kısmında select yapabilmek için bu kısmı yazdık ve yeni service açtık!
            return View();
        }
