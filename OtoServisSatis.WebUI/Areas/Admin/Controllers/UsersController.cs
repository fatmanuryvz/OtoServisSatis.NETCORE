...
namespace OtoServisSatis.WebUI.Areas.Admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(IService<Kullanici> service, IService<Rol> serviceRol) //servisin kullanıcı için çalışması için constructor yazdırdık-generate const'dan 
        {
            _service = service;
